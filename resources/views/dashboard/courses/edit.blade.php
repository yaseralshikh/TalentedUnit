      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">@lang('site.courses')</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">@lang('site.edit')</li>
                  <li class="breadcrumb-item"><a href="{{ route('dashboard.courses.index')}}">@lang('site.courses')</a></li>
                ...
                <form action="{{ route('dashboard.courses.update', $course->id) }}" method="post">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" rows="4" cols="50">{{ $course->description }}</textarea>
                      </div>
