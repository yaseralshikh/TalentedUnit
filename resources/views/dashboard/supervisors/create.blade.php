                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="اسم المشرق">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <img src="{{ asset('uploads/teacher_images/default.png') }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                      </div> 
                      </div>
                    </div>
                          ...
                          <div class="tab-content">
                            @foreach ($models as $index=>$model)
                              <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="{{ $model }}">
                                @foreach ($maps as $map)
                                    <label class="ml-3"><input type="checkbox" name="permissions[]" value="{{ $model . '_' . $map }}"> @lang('site.' . $map)</label>
                                @endforeach
                                <!-- /.post -->
                              </div>
                              <!-- /.tab-pane -->
