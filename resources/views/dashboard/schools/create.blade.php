                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="اسم المدرسة">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>@lang('site.moeid')</label>
                          <input type="number" name="moe_id" class="form-control" value="{{ old('moe_id') }}">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="stage" class="form-control">
                            @foreach ($stages as $stage)
                              <option value="{{ $stage }}" {{ old($stage) == $stage ? 'selected' : '' }}>{{ $stage }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
